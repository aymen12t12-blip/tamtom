...
export default function Layout({ children }: LayoutProps) {
  ...
  const shareText = getS('share_text', 'تسوق أفضل الأطعمة من تطبيق طمطوم!');
  const shareUrl = getS('share_url', window.location.origin);
  const sidebarImageUrl = getS('sidebar_image_url', 'https://images.unsplash.com/photo-1610348725531-843dff563e2c?q=80&w=400');
